...
image_process_provider::image_process_provider() {
  add<paint::detail::algorithms::bilinear_interoplation>(
      stretch_, "bilinear interpolation");
  add<paint::detail::algorithms::proximal_interoplation>(
      stretch_, "proximal interpolation");
...
paint::image_process::stretch_interface *const *
image_process_provider::stretch() const {
  return &stretch_.employee;
}

paint::image_process::stretch_interface *
image_process_provider::ref_stretch(const std::string &name) const {
  return _m_read(stretch_, name);
}

// alpha_blend
image_process_provider::alpha_blend_tag &
image_process_provider::ref_alpha_blend_tag() {
  return alpha_blend_;
}

paint::image_process::alpha_blend_interface *const *
image_process_provider::alpha_blend() const {
  return &alpha_blend_.employee;
}

paint::image_process::alpha_blend_interface *
image_process_provider::ref_alpha_blend(const std::string &name) const {
...
paint::image_process::blend_interface *const *
image_process_provider::blend() const {
  return &blend_.employee;
}

paint::image_process::blend_interface *
image_process_provider::ref_blend(const std::string &name) const {
...
paint::image_process::line_interface *const *
image_process_provider::line() const {
  return &line_.employee;
}

paint::image_process::line_interface *
image_process_provider::ref_line(const std::string &name) const {
...
paint::image_process::blur_interface *const *
image_process_provider::blur() const {
  return &blur_.employee;
}

paint::image_process::blur_interface *
image_process_provider::ref_blur(const std::string &name) const {
