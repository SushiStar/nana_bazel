...
public:
  ...
  enum class bidi_category { strong, weak = 0x1000, neutral = 0x2000 };
...
private:
  static unsigned _m_paragraph_level(const char_type *begin,
                                     const char_type *end);

  void _m_push_entity(const char_type *begin, const char_type *end,
                      unsigned level, bidi_char);
