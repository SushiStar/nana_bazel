...
///
/// The widget sets as shortkey the character behind the first of & in the text,
/// for the item. e.g. "File(&F)" or "&File".
class menubar
    : public widget_object<category::widget_tag, drawerbase::menubar::trigger,
                           ::nana::general_events,
                           drawerbase::menubar::scheme> {
public:
  ...
  /// Deselects the menu
  /**
   * If a menu is popped up, the menu deselects the item and close the pop-upped
   * menu.
