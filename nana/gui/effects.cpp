...
namespace impl {
class transparent : public bground_interface {
public:
...
class blur : public bground_interface {
public:
  blur(std::size_t radius) : radius_(radius) {}
...
// class bground_blur
bground_blur::bground_blur(std::size_t radius) : radius_(radius) {}
